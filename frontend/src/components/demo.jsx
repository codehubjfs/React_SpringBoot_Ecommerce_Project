            ...
            <div className="modal fade" id="PromocodeModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="mb-3">
                                <label htmlFor="subcategory-image-input" className="col-form-label">Sub-Category Image</label>
                                <input type="file" className="form-control" id="subcategory-image-input" name="subcategoryImage" onChange={handleInputChange} />
                                <div id="subcategoryImageError" style={{ color: 'red' }}>{formErrors.subcategoryImage}</div>
                            </div>
                        </div>
