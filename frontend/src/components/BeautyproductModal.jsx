...
const BeautyProductFormModal = ({ initialFormData, closeModal, onSubmit }) => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(updateProduct({ category: 'beauty', productData: formData }));
        closeModal();
    };
    ...
    return (
        <Modal show={show} onHide={handleClose} size="lg"> {/* Set size to "lg" for a large modal */}
            ...
            <Modal.Body>
                <div>
                    <h2 style={{ textAlign: 'center' }}>Beauty Product</h2>
                    <br />
                    <form onSubmit={handleSubmit}>
                        <div className="row mb-3">
                            ...
                            <div className="col-md-4">
                                ...
                                <textarea className="form-control fixed-textarea" id="description" name="description" value={formData.description} onChange={handleChange} rows="1" style={{ resize: 'none' }}></textarea>
                        ...
                        <div className="row mb-3">
                            ...
                            <input type="number" style={{display:'none'}} id="id" name="video" value={formData.id}  />
...
export default BeautyProductFormModal;