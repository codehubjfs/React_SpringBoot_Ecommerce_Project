...
const ElectronicProductForm = ({ subcategory }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        price: '',
        stockAvailable: '',
        supplierId: sellerDetails ? sellerDetails.sellerId : '',
        brand: '',
        model: '',
        displayType: '',
        displaySize: '',
    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            ...
            case 'price':
                ...
                break;
            case 'stockAvailable':
                newErrors.stockAvailable = value.trim() ? (value < 0 ? "Invalid input" : null) : "Stock available is required";
                break;
            case 'brand':
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row mb-3">
                    <div className="col-md-4">
                        <label htmlFor="displaySize" className="form-label">Display Size</label>
                        <input type="number" className="form-control" id="displaySize" name="displaySize" value={formData.displaySize} onChange={handleChange} />
                    ...
                    <div className="col-md-4">
                        ...
                        <input type="number" className="form-control" id="frontCamera" name="frontCamera" value={formData.frontCamera} onChange={handleChange} />
                ...
                <div className="row mb-3">
                    <div className="col-md-4">
                        <label htmlFor="rearCamera" className="form-label">Rear Camera</label>
                        <input type="number" className="form-control" id="rearCamera" name="rearCamera" value={formData.rearCamera} onChange={handleChange} />
                    ...
                    <div className="col-md-4">
                        ...
                        <input type="number" className="form-control" id="battery" name="battery" value={formData.battery} onChange={handleChange} />
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-md-4">
                        <label htmlFor="mainImage" className="form-label">Main Image URL<span style={{ color: 'red' }}>*</span></label>
                        <input type="text" className="form-control" id="mainImage" name="mainImage" value={formData.mainImage} onChange={handleChange} />
                        <div className="titleError" style={{ color: 'red' }} data-field="mainImage">
                            {errors.mainImage && <span>{errors.mainImage}</span>}
                        </div>
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="thumbnail1" className="form-label">Thumbnail 1 URL<span style={{ color: 'red' }}>*</span></label>
                        <input type="text" className="form-control" id="thumbnail1" name="thumbnail1" value={formData.thumbnail1} onChange={handleChange} />
                        <div className="titleError" style={{ color: 'red' }} data-field="thumbnail1">
                            {errors.thumbnail1 && <span>{errors.thumbnail1}</span>}
                        </div>
                    </div>
                </div>
                <div className="row mb-3">
                    <div className="col-md-4">
                        <label htmlFor="thumbnail2" className="form-label">Thumbnail 2 URL<span style={{ color: 'red' }}>*</span></label>
                        <input type="text" className="form-control" id="thumbnail2" name="thumbnail2" value={formData.thumbnail2} onChange={handleChange} />
                        <div className="titleError" style={{ color: 'red' }} data-field="thumbnail2">
                            {errors.thumbnail2 && <span>{errors.thumbnail2}</span>}
                        </div>
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="thumbnail3" className="form-label">Thumbnail 3 URL<span style={{ color: 'red' }}>*</span></label>
                        <input type="text" className="form-control" id="thumbnail3" name="thumbnail3" value={formData.thumbnail3} onChange={handleChange} />
                        <div className="titleError" style={{ color: 'red' }} data-field="thumbnail3">
                            {errors.thumbnail3 && <span>{errors.thumbnail3}</span>}
                        </div>
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="thumbnail4" className="form-label">Thumbnail 4 URL<span style={{ color: 'red' }}>*</span></label>
                        <input type="text" className="form-control" id="thumbnail4" name="thumbnail4" value={formData.thumbnail4} onChange={handleChange} />
                        <div className="titleError" style={{ color: 'red' }} data-field="thumbnail4">
                            {errors.thumbnail4 && <span>{errors.thumbnail4}</span>}
                        </div>
                    </div>
                </div>
                <div className="row mb-3">
                    <div className="col-md-4">
                        ...
                        <div className="titleError" style={{ color: 'red' }} data-field="video">
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="titleError" style={{ color: 'red' }} data-field="weight">
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="titleError" style={{ color: 'red' }} data-field="dimensions">
                            {errors.dimensions && <span>{errors.dimensions}</span>}
                        </div>
                    </div>
                </div>
                <div className="row mb-3">
                    <div className="col-md-4">
                        ...
                        <textarea className="form-control" id="additionalFeatures" name="additionalFeatures" value={formData.additionalFeatures} onChange={handleChange}></textarea>
                        <div className="titleError" style={{ color: 'red' }} data-field="additionalFeatures">
                            {errors.additionalFeatures && <span>{errors.additionalFeatures}</span>}
                        </div>
                    </div>
                </div>
                <div className="row mb-3">
