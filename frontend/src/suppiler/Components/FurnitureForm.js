...
const FurnitureForm = ({ subcategory }) => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(addProduct({ category: 'furniture', productData: formData }));
        ...
        <div id="sub-category2-form">
            <form onSubmit={handleSubmit}>
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-md-4">
                        <label htmlFor="dimension" className="form-label">Dimension<span style={{ color: 'red' }}>*</span></label>
                        <input type="text" className="form-control" id="dimension" name="dimension" value={formData.dimension} onChange={handleChange} />
