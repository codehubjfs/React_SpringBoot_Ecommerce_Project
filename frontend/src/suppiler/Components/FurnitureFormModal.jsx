...
const FurnitureFormModal = ({ initialFormData, closeModal }) => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(updateProduct({ category: 'furniture', productData: formData }));
                ...
                <div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-md-4">
                                <label htmlFor="product-dimension" className="form-label">Dimension<span style={{ color: 'red' }}>*</span></label>
